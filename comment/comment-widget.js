/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/comment/comment-widget.js"></script>
...
const s_stylePath = '/comment/comment-widget.css';
const s_formId = '1FAIpQLSdKmyENgp-t3-trePJsag5lMkYtZBOlRcsL7m6a0OFu94EiDw';
const s_nameId = '1657368606';
const s_websiteId = '950654889';
const s_textId = '1581734564';
const s_pageId = '1026769143';
const s_replyId = '1488646746';
const s_sheetId = '1aUqZw3EvrAh6PD4j_rbw5JWexwCf3dbbn557SXZmSU8';
